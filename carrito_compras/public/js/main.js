$(document).ready(function(){
    ...
    $('.back-system-button').on('click', function(e){
        e.preventDefault();
        var LinkBackSystem=$(this).attr("data-href");
        swal({
            title: "¿Estás seguro?",
            text: "Quieres regresar a la pagina anterior",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#5cb85c",
            ...
            window.location=LinkBackSystem; 
        });  
    });
    
    $('.inicio-sesion-button').on('click', function(e){
        e.preventDefault();
        var LinkBackSystem=$(this).attr("data-href");
        swal({
            title: "¿Estás seguro?",
            text: "Quieres ir a la pagina de inicio de sesion?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#5cb85c",
